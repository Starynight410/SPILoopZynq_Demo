...
#
# Generated by Vivado on Tue Aug 27 16:10:30 +0800 2024
...
# Design libraries
design_libs=(xilinx_vip xpm fifo_generator_v13_2_6 xil_defaultlib)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"F:/Xilinx/Vivado/2021.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"F:/Xilinx/Vivado/2021.2/data/xilinx_vip/include" \
  ...
  vlogan -work fifo_generator_v13_2_6 $vlogan_opts +v2k +incdir+"F:/Xilinx/Vivado/2021.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"F:/Xilinx/Vivado/2021.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../01_app_hyis_ptc0808.gen/sources_1/ip/fifo_generator_0/sim/fifo_generator_0.v" \
  2>&1 | tee -a vlogan.log
